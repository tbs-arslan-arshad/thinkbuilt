...
const Hero = () => {
  return (
    <section
      ...
      <h1 className="text-white text-4xl sm:text-5xl md:text-7xl xl:text-8xl 2xl:text-9xl  mt-[25.82] px-4 md:px-8 lg:px-12">
        Clarity Before&nbsp;
      ...
      <p className="text-white sm:text-lg lg:text-xl xl:text-2xl  text-center mt-[33.82]">
