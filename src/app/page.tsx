        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 min-h-[400px] lg:min-h-[600px]">
            <div className="flex flex-col text-white w-full max-w-[700px] pt-6 sm:pt-8 lg:pt-12">
              ...
              <div className="flex mt-6 sm:mt-8 lg:mt-10 bg-[#1D9ED9] rounded-full border border-[#1D9ED9] py-2 sm:py-3 sm:px-4 w-full max-w-[307px] items-center justify-center text-md  lg:text-lg font-medium hover:bg-[#1678a1] transition-colors">
